                                    ...
                                    {this.state.cartList.map((item) => (
                                        <div key={item.id} className="product-widget">
                                            <div className="product-img">
                                                <img src={item.stock.product.photo && require(`../../assets/img/${item.stock.product.photo}`) ? require(`../../assets/img/${item.stock.product.photo}`) : require('../../assets/img/hotdeal.png')} alt={item.stock.product.name} />
